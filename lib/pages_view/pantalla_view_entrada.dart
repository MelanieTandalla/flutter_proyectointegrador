              ...
              OutlinedButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => agregar_provedor()));
                },
    ...
    return TextButton(
      onPressed: () => showDialog<String>(
        ...
        builder: (BuildContext context) => AlertDialog(
          content:
              const Text('¿Esta seguro que quiere eliminar este producto?'),
          actions: <Widget>[
            TextButton(
            ...
            TextButton(
              ...
              child: const Text(
                'Aceptar',
                style: TextStyle(color: Color.fromRGBO(6, 67, 210, 1)),
              ),
            ),
          ],
        ),
